...
const (
        nginxVirtualServerTmpl       = "./../../../../tmpl/nginx-plus.virtualserver.tmpl"
        nginxTransportServerTmpl     = "./../../../../tmpl/nginx-plus.transportserver.tmpl"
)
...
func TestExecuteVirtualServerTemplate_RendersTemplateWithServerGunzipOn(t *testing.T) {
    ...
    t.Parallel()
    executor := newTmplExecutorNGINXPlus(t)
    data, err := executor.ExecuteVirtualServerTemplate(&virtualServerCfgWithGunzipOn)
    if err != nil {
        t.Error(err)
    }
    output := "/tmp/app-http-gzip.conf"
    ioutil.WriteFile(output, data, 0644)
    t.Log("output to file ", output)
}
...
func TestExecuteVirtualServerTemplate_RendersTemplateWithServerGunzipOff(t *testing.T) {
    ...
    t.Parallel()
    executor := newTmplExecutorNGINXPlus(t)
    data, err := executor.ExecuteVirtualServerTemplate(&virtualServerCfgWithGunzipOff)
    if err != nil {
        t.Error(err)
    }
    output := "/tmp/app-http-gzip-off.conf"
    ioutil.WriteFile(output, data, 0644)
    t.Log("output to file ", output)
}
...
func TestExecuteVirtualServerTemplate_RendersTemplateWithServerGunzipNotSet(t *testing.T) {
    ...
    t.Parallel()
    executor := newTmplExecutorNGINXPlus(t)
    data, err := executor.ExecuteVirtualServerTemplate(&virtualServerCfgWithGunzipNotSet)
    if err != nil {
        t.Error(err)
    }
    output := "/tmp/app-http-gzip-none.conf"
    ioutil.WriteFile(output, data, 0644)
    t.Log("output to file ", output)
}
...
func TestExecuteVirtualServerTemplate_RendersTemplateWithSessionCookieSameSite(t *testing.T) {
    ...
    t.Parallel()
    executor := newTmplExecutorNGINXPlus(t)
    data, err := executor.ExecuteVirtualServerTemplate(&virtualServerCfgWithSessionCookieSameSite)
    if err != nil {
        t.Error(err)
    }
    output := "/tmp/app-http-session-cookie.conf"
    ioutil.WriteFile(output, data, 0644)
    t.Log("output to file ", output)
}
...
func TestExecuteVirtualServerTemplate_RendersTemplateWithCustomListener(t *testing.T) {
    ...
    t.Parallel()
    executor := newTmplExecutorNGINXPlus(t)
    data, err := executor.ExecuteVirtualServerTemplate(&virtualServerCfgWithCustomListener)
    if err != nil {
        t.Error(err)
    }
    output := "/tmp/app-http-customize-listener.conf"
    ioutil.WriteFile(output, data, 0644)
    t.Log("output to file ", output)
}
